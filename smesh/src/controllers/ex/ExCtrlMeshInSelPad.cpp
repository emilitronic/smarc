// **********************************************************************
// smesh/src/controllers/ex/ExCtrlMeshInSelPad.cpp
// **********************************************************************
...
ExCtrlMeshInSelPad::ExCtrlMeshInSelPad(std::string /*name*/, IMPL_CTOR) {
  UPDATE(updateReadRespReady)
      .reads(cntl_bits,
             mesh_cntl_deq_fire,
             mesh_a_fire, mesh_b_fire, mesh_d_fire,
             spad_read_resp_data, accum_read_resp_data)
      .writes(spad_read_resp_rdy, accum_read_resp_rdy);
