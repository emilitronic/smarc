...
|---|---|---|
| `tb_ex_ctrl.cpp` | Predecessor of `basic`; adds detailed internal traces and checks exact completion order. | Passes, but substantially overlaps `basic`. |
...
The two passing older tests remain useful for their established diagnostic
traces. Their functional scenarios should normally be extended in the
maintained suite instead of adding more duplicated standalone harness code.
