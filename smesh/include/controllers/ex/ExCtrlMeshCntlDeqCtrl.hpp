// **********************************************************************
// smesh/include/controllers/ex/ExCtrlMeshCntlDeqCtrl.hpp
// **********************************************************************
...
class ExCtrlMeshCntlDeqCtrl : public Component {
 ...
 public:
  ...
  Output(bit, mesh_req_fire);       // Mesher accepts the request this cycle (currently only used by FSM for flush control)
